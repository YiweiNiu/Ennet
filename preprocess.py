...
def preprocess(network_file, enhancer_file):
    ...
    print 'Network initiation done: %s genes and %s links included.' %(x1, y1)
    ...
    print 'Reading enhancer-gene interactions done: %s enhancers, %s genes and %s interactions included. And %s genes are not in the network.' %(enh_num, new_gene_num, y2-y1, x2-x1-enh_num)
